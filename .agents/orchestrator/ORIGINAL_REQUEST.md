...
## Initial Request — 2026-05-27T03:10:18+08:00

Please execute the following user request. Ensure you adhere to all requirements, especially the Language and Safety Rules (Simplified Chinese, Windows PowerShell MCP tool edits only, etc.).
